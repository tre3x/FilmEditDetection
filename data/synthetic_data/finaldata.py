...
class reader():
    ...
    '''
    def __init__(self, csvpath, fps, framenum, nocut = False):
        self.here = os.path.dirname(os.path.abspath(__file__))
...
if __name__=="__main__":
    reader("/home/tre3x/Python/FilmEditsDetection/data/synthetic_data/results/softcuts/timestamps.csv", 24, 50, False).run()
    reader("/home/tre3x/Python/FilmEditsDetection/data/synthetic_data/results/softcuts/timestamps.csv", 24, 50, True).run()